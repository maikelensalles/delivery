                    ...
                    <div class="card shadow">
                        <div class="p-4 bg-secondary">
                            <h1>Cadastrar Novo Local</h1> 
                                <form method="post" action="{{ route('locais.store') }}" enctype="multipart/form-data" autocomplete="off">
                                    @csrf
                                    <div class="pl-lg-4">
                                        <div class="form-group{{ $errors->has('nome') ? ' has-danger' : '' }}">
                                            ...
                                            @include('alerts.feedback', ['field' => 'nome'])
                                                ...
                                                <div class="form-group{{ $errors->has('valor') ? ' has-danger' : '' }}">
                                                    ...
                                                    <input type="number" step=".01" name="valor" id="input-valor" class="form-control form-control-alternative" placeholder="Taxa de Entrega" value="{{ old('valor') }}" required>
